...
<div id="caracterizacion" class="hidden">
	<div class="container-fluid">		
		<div class="form-group form-group-sm col-xs-12 col-sm-3 ">
			...
			<div class='small'>
				<input type='text' class='form-control input-sm text-right validar' id='' name='i1r2c' value = "<?php //echo $row['d1r2c1']?>" maxlength="9" />
			</div>
		</div>
		...
		<div class="form-group form-group-sm col-xs-12 col-sm-3 ">
			...
			<div class='small'>
				<select class='form-control input-sm validar' id="" name="i1r2c">
	...
	<div class="container-fluid">
		...
		<div class="form-group form-group-sm col-xs-12 col-sm-3 ">
			...
			<div class='small'>
				<input type='text' class='form-control input-sm text-right validar' id='' name='i1r2c' value = "<?php //echo $row['i1r2c']?>" maxlength="9" />
			</div>
		</div>
		<div class="col-xs-12 col-sm-1"></div>
		<div class="form-group form-group-sm col-xs-12 col-sm-3 ">
